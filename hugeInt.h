...
private:
  ...
  std::vector<int16_t> sumHugeInts(const std::vector<int16_t> &lhs,
                                   const std::vector<int16_t> &rhs) const;
  std::vector<int16_t> subHugeInts(const std::vector<int16_t> &rhs) const;
  void setVector(const std::vector<int16_t> &rhs);
  std::vector<int16_t> multipHugeInts(const std::vector<int16_t> &lhs,
                                      const std::vector<int16_t> &rhs) const;
